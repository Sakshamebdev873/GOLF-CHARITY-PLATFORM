...
export default function AdminUsersPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto w-full">
      ...
      >
        <div>
          <h1 className="font-display font-bold text-2xl sm:text-3xl text-white mb-1 sm:mb-2">
            Users
          </h1>
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="border-b border-white/[0.06]">
                  ...
                  <th className="text-xs text-dark-500 font-medium px-6 py-4 uppercase tracking-wider whitespace-nowrap">
                    User
                  </th>
                  <th className="text-xs text-dark-500 font-medium px-6 py-4 uppercase tracking-wider whitespace-nowrap">
                    Role
                  ...
                  <th className="text-right text-xs text-dark-500 font-medium px-6 py-4 uppercase tracking-wider whitespace-nowrap">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody>
                {users.map((u: any) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`text-xs px-2 py-1 rounded-md ${u.role === "ADMIN" ? "bg-red-500/10 text-red-400" : "bg-brand-500/10 text-brand-400"}`}
                      >
                        {u.role}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`text-xs px-2 py-1 rounded-md ${u.isActive ? "bg-brand-500/10 text-brand-400" : "bg-red-500/10 text-red-400"}`}
                      >
