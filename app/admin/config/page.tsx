...
export default function AdminConfigPage() {
  ...
  const [upsertConfig, { isLoading: saving }] = useUpsertConfigMutation();
  ...
  const handleDelete = async (key: string) => {
    ...
    try { await deleteConfig(key).unwrap(); } catch {}
  };
                  ...
                  <tr key={c.key} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-4 sm:px-6 py-4 min-w-[200px]">
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-white/[0.04] border border-white/[0.06] rounded-lg text-sm text-white focus:outline-none focus:border-red-500/50 transition-all" 
                      />
                    </td>
